        ...
        <section className="max-w-300 mx-auto px-8 md:px-32 py-30 grid md:grid-cols-2 gap-10 items-center">
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex gap-4 pt-8">
              <button onClick={() => navigate("/onboarding")} className="bg-primary-container text-black font-body text-body px-8 py-4 rounded-none font-bold hover:bg-primary-fixed transition-transform hover:-translate-y-px">INICIAR ONBOARDING</button>
        ...
        <section className="relative max-w-300 mx-auto px-8 md:px-32 py-30 text-center overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col items-center gap-4">
              <button onClick={() => navigate("/onboarding")} className="bg-primary-container text-black font-body text-body px-12 py-5 rounded-none font-extrabold hover:bg-primary-fixed transition-transform hover:-translate-y-px uppercase tracking-wider">INICIAR ONBOARDING</button>
