...
export default function SettingsPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h2 className="text-[28px] font-bold text-[#f0ffe4] md:text-heading-lg">Configuración</h2>
      ...
      <div className="space-y-6">
        <div className="border border-[#3c4b35] bg-[#182214] p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h3 className="font-mono text-body-sm font-bold uppercase tracking-wider text-[#f0ffe4]">Seguridad</h3>
          </div>
        ...
        <div className="border border-[#3c4b35] bg-[#182214] p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h3 className="font-mono text-body-sm font-bold uppercase tracking-wider text-[#f0ffe4]">Notificaciones</h3>
          </div>
          <div className="space-y-4">
            <label className="flex items-center justify-between">
        ...
        <div className="border border-[#3c4b35] bg-[#182214] p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h3 className="font-mono text-body-sm font-bold uppercase tracking-wider text-[#f0ffe4]">Región</h3>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-[#dae6d0]">Zona horaria</span>
              <select className="border border-[#3c4b35] bg-[#141e10] px-3 py-1.5 font-mono text-caption-mono text-[#dae6d0] outline-none">
        ...
        <div className="border border-[#3c4b35] bg-[#182214] p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h3 className="font-mono text-body-sm font-bold uppercase tracking-wider text-[#f0ffe4]">Sincronización</h3>
          </div>
          <p className="mb-4 text-[13px] text-[#baccaf]">
            Los datos se sincronizan automáticamente cada 5 minutos.
          </p>
          <button className="border border-[#42ff00] bg-[#42ff00]/10 px-4 py-2 font-mono text-caption-mono uppercase tracking-wider text-[#42ff00] transition-all hover:bg-[#42ff00] hover:text-[#083900]">
